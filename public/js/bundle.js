...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"../../node_modules/pxmu/dist/npm/index.min.js":[function(require,module,exports) {
"use strict";
...
var d = .3,
  ...
  toast: !0
    ...
    _pxmuToCount = 0,
    _pxmuClassName = "pxmu-class__name__fix";
const $pxmu = {
  _init: function () {
    var t = this,
    ...
    e.styleSheet ? e.styleSheet.cssText = i : e.innerHTML = i, document.getElementsByTagName("head")[0].appendChild(e), window.addEventListener("click", function (e) {
      if (e.target.dataset.pxmuCopyText) {
        let i = t.copy(e.target.dataset.pxmuCopyText);
        i && t.toast("复制成功");
      }
    });
  },
  ...
  overlap: function (t) {
    "object" == typeof t && t && (!1 === t.loading ? _overlap.loading = !1 : _overlap.loading = !0, !1 === t.toast ? _overlap.toast = !1 : _overlap.toast = !0);
  },
  copy: function (t = "") {
    var e = this;
    if ("object" != typeof t) return e.addcopy(t);

    if (t.el) {
      let n = t.el.substr(0, 1);
      if ("#" == n) var i = t.el.split("#");else {
        if ("." != n) return {
          status: 0,
          msg: "el入参错误"
        };
      ...
      i = !i[0] && i[1] ? i[1] : i[0] && i[1] ? i[1] : i[0];
      var o = "";

      if (o = "#" == n ? document.getElementById(i) : document.getElementsByClassName(i)[0], o) {
        let t = o.innerText;
        return e.addcopy(t);
      }
  ...
  loading: function (t) {
    var e = this;
    e.addLoading("loading", t);
  },
  success: function (t) {
    var e = this;
    e.addLoading("success", t);
  },
  fail: function (t) {
    var e = this;
    e.addLoading("fail", t);
  ...
  diaglog: function (t) {
    ...
    if ("object" == typeof t) {
      for (let e in t) for (let o in t[e]) if ("btn" == e) for (let n in t[e][o]) i[e][o][n] = t[e][o][n];else i[e][o] = t[e][o];
    } else i.content.text = t;
    let o = i.content.text;
    o && "string" == typeof o && (i.content.text = o.replace(/\n/g, "</br>"), o = null), !0 === i.congif.btnstyle ? i.congif.btnstyle = 50 : i.congif.btnstyle = 3;
    var n = document.createElement("div"),
        a = "pxmu-diag-item";
    i.congif.inscroll && (a += " pxmu-diag-inscroll", document.getElementsByTagName("body")[0].className += " pxmu-body-inscroll"), n.setAttribute("style", "background:" + i.congif.bg), n.setAttribute("class", a);
    var s = '<div class="pxmu-diag">';
    "none" != i.congif.animation && (s = '<div class="pxmu-diag pxmu-' + i.congif.animation + '-in">');
    var r = "";
    i.title.text && (r = "padding-top:15px;font-weight: " + i.title.fontweight + ";color: " + i.title.color + ";font-size: " + parseInt(i.title.fontsize) + "px;", !0 === i.title.center && (r += "text-align:center;"), i.content.text || (r += "margin:15px 0"), s += '<div style="' + r + '">' + i.title.text + "</div>"), i.content.text && (r = "font-size: " + i.content.fontsize + "px;color: " + i.content.color, s += '<div class="pxmu-diag-text" style="' + r + '">' + i.content.text + "</div>");
    let l = "";
    !isNaN(i.line.solid) && i.line.solid > 0 && (s += '<div style="margin:10px 0;height:' + i.line.solid + "px;background:" + i.line.color + '"></div>', l = "padding:0;height:auto;margin:0;"), s += '<div style="' + l + '" class="pxmu-diag-btn">', !1 === i.congif.btncount && (r = l + ";background: " + i.btn.left.bg + ";color: " + i.btn.left.color + ";border: solid " + i.btn.left.solid + "px " + i.btn.left.solidcolor + ";font-size:" + i.btn.left.fontsize + "px;", r += "font-weight:" + i.btn.left.fontweight + ";border-radius: " + i.congif.btnstyle + "px;", s += '<div style="' + r + '" class="pxmu-diag-btn-left"> ' + i.btn.left.text + " </div>", s += l ? '<span style="width:1px;background:' + i.line.color + '"></span>' : '<span style="flex:0.1"></span>'), r = l + ";background: " + i.btn.right.bg + ";color: " + i.btn.right.color + ";border: solid " + i.btn.right.solid + "px " + i.btn.right.solidcolor + ";font-size:" + i.btn.right.fontsize + "px;", r += "font-weight:" + i.btn.right.fontweight + ";border-radius: " + i.congif.btnstyle + "px;", s += '<div style="' + r + '" class="pxmu-diag-btn-right"> ' + i.btn.right.text + " </div>", s += "</div></div></div>", n.innerHTML = s, document.body.appendChild(n);
    ...
    return m(".pxmu-diag-item").onclick = function (t) {
      if (!1 === i.congif.cbcloseall && !1 === i.congif.cbclose && !0 === i.congif.anclose) return e.closediaglog(0, i.congif.animation), !1;
      t.target.className, t.target.className;
    }, new Promise((t, o) => {
      m(".pxmu-diag-btn").onclick = function (o) {
        var n = {
          type: "click",
          btn: "right"
        };
        if ("pxmu-diag-btn-left" == o.target.className && (n.btn = "left", t(n)), "pxmu-diag-btn-right" == o.target.className && (t(n), !0 === i.congif.cbclose || !0 === i.congif.cbcloseall)) return !0 === i.congif.cbload && (s = '<span class="pxmu-circular-in" style="width:20px;color:' + i.congif.cbloadcolor + '"><svg viewBox="25 25 50 50" class="pxmu-loading-icon"><circle cx="50" cy="50" r="20" fill="none"></circle></svg></span>', i.congif.cbloadtext && (s += '<span style="padding-left: 5px;">' + i.congif.cbloadtext + "</span>"), m(".pxmu-diag-btn-right").innerHTML = s), !1;
        !1 === i.congif.cbcloseall && e.closediaglog(0, i.congif.animation);
      };
    });
  },
  closediaglog: function (t = 0, e = "none") {
    var i = this;
    if (i.pxmulog(e), !1 === t) return !1;
    let o = 300;
    "none" == e && (o = 0);
    var n = document.getElementsByClassName("pxmu-diag");
    n && n[0] && n[0].setAttribute("class", "pxmu-diag pxmu-" + e + "-out"), i._close_html_diaglog(o, "pxmu-diag-item", e);
  },
  closeload: function (t = 0) {
    var e = this;

    e._close_html_diaglog(t, "pxmu-loading-item");
  },
  _close_html_diaglog: function (t = 0, e, i) {
    var o = this;
    t = parseInt(t), setTimeout(function () {
      o._body_remove_inscroll();
      ...
      for (var a = 0; a < n; a++) {
        ...
        o.pxmulog(e);
        let n = 0;
        "none" != i && (e += " pxmu-fade-out", t[a].setAttribute("class", e), n = d), setTimeout(function () {
          t[0] && document.body.removeChild(t[0]);
        }, 1e3 * n);
      }
    }, t);
  },
  addLoading: function (t, e) {
    var i = this;
    ...
    var o = {
      msg: e.msg || "",
      time: e.time || 2500,
      bg: e.bg || "rgba(0, 0, 0, 0.65)",
      color: e.color || "#fff",
      animation: e.animation || "fade",
      close: !1 !== e.close,
      inscroll: !0 === e.inscroll,
      inscrollbg: e.inscrollbg || ""
    };

    if (!0 === _overlap.loading) {
      var n = document.getElementsByClassName("pxmu-loading-item")[0];
      i.pxmulog(n), n && (document.body.removeChild(n), i._body_remove_inscroll());
    }

    o.time = parseInt(o.time);
    var a = document.createElement("div");
    _pxmuToCount++;
    let s = _pxmuClassName + _pxmuToCount,
        r = "pxmu-loading-item pxmu-fixed " + s;
    o.inscroll && (r += " pxmu-loading-inscroll", document.getElementsByTagName("body")[0].className += " pxmu-body-inscroll"), a.setAttribute("class", r), o.inscrollbg && a.setAttribute("style", "background:" + o.inscrollbg);

    let l = i._pxmu_get_load_Type(t, o.color);

    if (!l) return !1;
    var m = '<div class="pxmu-loading pxmu-' + o.animation + '-in" style="background:' + o.bg + ";color:" + o.color + ';">';
    m += '<div class="pxmu-loading-ing"><span style="color:' + o.color + ';" class="pxmu-loading-spinner pxmu-loading-spinner-' + t + " pxmu-loading-circular-" + t + '">' + l + '</span></div><div class="pxmu-toast-text">' + o.msg + "</div></div>", a.innerHTML = m, document.body.appendChild(a), o.close && setTimeout(function () {
      a.setAttribute("class", r + " pxmu-" + o.animation + "-out"), setTimeout(function () {
        n = document.getElementsByClassName(s)[0], i.pxmulog(s), n && document.body.removeChild(n), i._body_remove_inscroll();
      }, 1e3 * d);
    }, o.time);
  },
  _body_remove_inscroll: function () {
    let t = document.getElementsByTagName("body")[0].classList.value;
    -1 != t.indexOf("-inscroll") && document.getElementsByTagName("body")[0].classList.remove("pxmu-body-inscroll");
  },
  ...
  toast: function (t = "") {
    ...
    if ("object" != typeof t) {
      ...
      t = {};
      t.msg = e, t.location = "";
    } else t.time = parseInt(t.time);

    t.type = t.type || "wap", t.status = t.status || "success", "pc" == t.type ? t.animation = t.animation || "slidedown" : t.animation = t.animation || "fade", t.location = t.location || "bottom", _pxmuToCount++;
    let i = _pxmuClassName + _pxmuToCount;
    var o = {
      class: `pxmu-toast pxmu-toast-${t.type} pxmu-toast-${t.location} ${i}`,
      msg: t.msg || "操作成功",
      time: t.time || 2500,
      bg: t.bg || "rgba(0, 0, 0, 0.86)",
      color: t.color || "#fff"
    };

    if (!0 === _overlap.toast) {
      var n = document.getElementsByClassName("pxmu-toast")[0];
      e.pxmulog(n), n && document.body.removeChild(n);
    }

    var a = document.createElement("div");
    a.setAttribute("class", o.class);
    let s = "background-color:" + o.bg + ";color:" + o.color + ";",
        r = `<div class="pxmu-${t.status} pxmu-${t.animation}-in"><div style="${s}">${o.msg}</div></div>`;
    a.innerHTML = r, document.body.appendChild(a), setTimeout(function () {
      a.setAttribute("class", o.class + " pxmu-" + t.animation + "-out"), setTimeout(function () {
        n = document.getElementsByClassName(i)[0], e.pxmulog(i), n && document.body.removeChild(n);
      }, 1e3 * d);
    }, o.time);
  }
};
...
var _default = exports.default = $pxmu;
...
exports.showAlert = exports.isLoading = void 0;

var _pxmu = _interopRequireDefault(require("pxmu"));
...
var isLoading = exports.isLoading = function isLoading(msg, flag) {
  // let bg =
  //   msg === '修改成功!!!' ? 'rbga(1,200,91,0.65)' : 'rgba(0, 0, 0, 0.65)';
  _pxmu.default.loading({
    msg: msg,
    //loading信息 为空时不显示文本
    time: 2500,
    //停留时间
    ...
    //动画名 详见动画文档
    close: false,
    // 自动关闭 为false时可在业务完成后调用 pxmu.closeload();手动关闭
    inscroll: false,
    //模态 不可点击和滚动
  ...
  if (flag !== 1) _pxmu.default.closeload(100); //延时100毫秒关闭 默认0
};
},{"pxmu":"../../node_modules/pxmu/dist/npm/index.min.js"}],"login.js":[function(require,module,exports) {
"use strict";
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success' && type !== 'password') (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated Successfull!"));
...
// tour.pug中引入了stripe;
var stripe = Stripe('pk_test_51OGLnELDieBNJEvwiCWYKxhN1q9mgRgpjsod4jabUriJSDPzwyw18ZADEqSRlZiAyVPNUyAXZ559E0uhIv1vPOYs00cENDPI81');
...
var userUpdatePasswordForm = document.querySelector('.form-user-password');
...
if (userUpdatePasswordForm) {
  userUpdatePasswordForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    _regeneratorRuntime().mark(function _callee(e) {
      var passwordCurrent, password, passwordConfirm, res;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            (0, _alerts.isLoading)('正在加载中...', 1);
          ...
          case 7:
            ...
            if (res === 1) {
              (0, _alerts.isLoading)('修改成功!!!', -1);
            } else {
              (0, _alerts.isLoading)(' ', -1);
            }
